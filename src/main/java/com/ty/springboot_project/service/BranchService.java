...
public class BranchService {
	...
	public ResponseEntity<ResponseStructure<Branch>> updateBranch(Branch branch, int id) {
		...
		if (branch2 != null) {
			...
			throw new IdNotFoundException("No branch is present for the given branch id");
		}
	...
	public ResponseEntity<ResponseStructure<List<Branch>>> getAllBranchByHospitalId(int hid) {
		...
		if (branch != null) {
			...
			throw new IdNotFoundException("No branch is present for the given hospital id");
		}
